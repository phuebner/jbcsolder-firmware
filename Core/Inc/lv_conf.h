...
#define LV_FONT_CUSTOM_DECLARE 	LV_FONT_DECLARE(lv_font_montserrat_80) \
								...
								LV_FONT_DECLARE(lv_font_roboto_34) \
...
#define LV_THEME_DEFAULT_COLOR_PRIMARY      lv_color_hex(0xC70039)
#define LV_THEME_DEFAULT_COLOR_SECONDARY    lv_color_hex(0x00c78e)
